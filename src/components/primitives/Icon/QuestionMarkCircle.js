...
export const QuestionMarkCircle = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ margin: 5 }}>
    ...
    <path d="M12 17H12.01" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
